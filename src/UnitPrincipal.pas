...
begin
    ...
    begin
        ...
        begin
            ...
            TListItemText(Objects.FindDrawable('Txt_nome')).Text := 'Clínica' + i.ToString; // procura o name do objeto
            TListItemText(Objects.FindDrawable('Txt_endereco')).Text := 'Avenida Rio de Janeiro' + sLineBreak +
                                                                        'São Conrado - Aracaju' + sLineBreak +
                                                                        '(79)0000-1111';
        end;
    end;
end;
...
begin
    ...
    img.Opacity := 1;
    //acessa a tag da respectiva imagem e o outro parâmetro passa uma animação
